...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  Volquag: {
    types: ['Water', 'Fire'],
    bs: {hp: 90, at: 97, df: 114, sa: 100, sd: 86, sp: 65},
    weightkg: 0.5,
    abilities: {0: 'Unaware'},
  },
  Toxalure: {
    types: ['Ghost', 'Water'],
    bs: {hp: 75, at: 59, df: 121, sa: 109, sd: 126, sp: 57},
    weightkg: 13,
    abilities: {0: 'Merciless'},
  },
  Kingtsar: {
    types: ['Water', 'Grass'],
    bs: {hp: 65, at: 145, df: 106, sa: 50, sd: 74, sp: 91},
    weightkg: 175,
    abilities: {0: 'Water Absorb'},
  },
  Tanette: {
    types: ['Grass', 'Fairy'],
    bs: {hp: 60, at: 50, df: 100, sa: 95, sd: 80, sp: 50},
    weightkg: 0.5,
    abilities: {0: 'Regenerator'},
    nfe: true,
  },
  Slowton: {
    ...
    bs: {hp: 92, at: 62, df: 97, sa: 115, sd: 100, sp: 50},
    weightkg: 150,
    abilities: {0: 'Analytic'},
  },
  Flaant: {
    types: ['Grass', 'Bug'],
    bs: {hp: 76, at: 124, df: 109, sa: 76, sd: 59, sp: 109},
    weightkg: 1,
    abilities: {0: 'Hustle'},
  },
  Umbat: {
    types: ['Dark', 'Flying'],
    bs: {hp: 115, at: 82, df: 110, sa: 70, sd: 110, sp: 112},
    weightkg: 50.9,
    abilities: {0: 'Inner Focus'},
  },
  Chomplim: {
    types: ['Ground', 'Ghost'],
    bs: {hp: 129, at: 105, df: 79, sa: 105, sd: 79, sp: 91},
    weightkg: 50,
    abilities: {0: 'Rough Skin'},
  ...
  'Chomplim-Mega': {
    types: ['Ground', 'Ghost'],
    bs: {hp: 129, at: 145, df: 99, sa: 145, sd: 89, sp: 81},
    weightkg: 30,
    abilities: {0: 'Sand Force'},
  ...
  Xotalion: {
    types: ['Psychic', 'Steel'],
    bs: {hp: 78, at: 102, df: 99, sa: 102, sd: 71, sp: 111},
    weightkg: 0,
    abilities: {0: 'Justified'},
  },
  Miemie: {
    types: ['Psychic', 'Fighting'],
    bs: {hp: 70, at: 109, df: 72, sa: 109, sd: 72, sp: 121},
    weightkg: 8,
    abilities: {0: 'Regenerator'},
  },
  Dusking: {
    types: ['Ghost', 'Poison'],
    bs: {hp: 80, at: 85, df: 125, sa: 90, sd: 125, sp: 40},
    weightkg: 34,
    abilities: {0: 'Regenerator'},
  },
  Jelliswine: {
    types: ['Ghost', 'Ground'],
    bs: {hp: 105, at: 95, df: 85, sa: 97, sd: 87, sp: 75},
    weightkg: 0,
    abilities: {0: 'Thick Fat'},
  },
  Pigapult: {
    types: ['Fire', 'Dragon'],
    bs: {hp: 89, at: 116, df: 65, sa: 95, sd: 65, sp: 118},
    weightkg: 7.7,
    abilities: {0: 'Infiltrator'},
  },
  Silvino: {
    types: ['Normal'],
    bs: {hp: 100, at: 90, df: 95, sa: 90, sd: 95, sp: 75},
    weightkg: 78,
    abilities: {0: 'RKS System'},
    otherFormes: [
      'Silvino-Bug',
      ...
      'Silvino-Dark-Mega',
      'Silvino-Dragon-Mega',
      'Silvino-Electric-Mega',
      'Silvino-Fighting-Mega',
      'Silvino-Fire-Mega',
      'Silvino-Flying-Mega',
      'Silvino-Ghost-Mega',
      'Silvino-Grass-Mega',
  ...
  'Silvino-Bug-Mega': {
    types: ['Bug', 'Fairy'],
    bs: {hp: 100, at: 90, df: 135, sa: 110, sd: 135, sp: 75},
    weightkg: 320,
    abilities: {0: 'Healer'},
    baseSpecies: 'Silvino',
  },
  ...
  'Lycanserker-Dusk': {
    types: ['Rock', 'Steel'],
    bs: {hp: 77, at: 118, df: 87, sa: 57, sd: 87, sp: 105},
    weightkg: 120,
    abilities: {0: 'Tough Claws'},
  },
  'Tapu Lop': {
    types: ['Normal', 'Fairy'],
    bs: {hp: 80, at: 80, df: 79, sa: 103, sd: 105, sp: 116},
    weightkg: 8.5,
    abilities: {0: 'Klutz'},
    otherFormes: ['Tapu Lop-Mega'],
  },
  'Tapu Lop-Mega': {
    types: ['Normal', 'Fighting'],
    bs: {hp: 80, at: 140, df: 89, sa: 103, sd: 105, sp: 146},
    weightkg: 215,
    abilities: {0: 'Scrappy'},
  ...
  Dragontler: {
    types: ['Normal', 'Flying'],
    bs: {hp: 85, at: 125, df: 80, sa: 95, sd: 85, sp: 100},
    weightkg: 33,
    abilities: {0: 'Multiscale'},
  },
  Eternabat: {
    types: ['Dragon', 'Flying'],
    bs: {hp: 103, at: 73, df: 73, sa: 118, sd: 73, sp: 106},
    weightkg: 4,
    abilities: {0: 'Pressure'},
  },
  Grimmlurk: {
    types: ['Fairy', 'Ghost'],
    bs: {hp: 95, at: 125, df: 90, sa: 75, sd: 90, sp: 60},
    weightkg: 310.5,
    abilities: {0: 'Prankster'},
  },
  'Manicuno-Galar': {
    types: ['Ice', 'Psychic'],
    bs: {hp: 100, at: 112, df: 74, sa: 97, sd: 88, sp: 97},
    weightkg: 650,
    abilities: {0: 'Plus'},
  },
  'Yacian-Crowned': {
    types: ['Ground', 'Steel'],
    bs: {hp: 66, at: 125, df: 100, sa: 66, sd: 105, sp: 89},
    weightkg: 16,
    abilities: {0: 'Wandering Spirit'},
  },
  Dongoro: {
    types: ['Ground', 'Dark'],
    bs: {hp: 102, at: 132, df: 109, sa: 74, sd: 75, sp: 64},
    weightkg: 16,
    abilities: {0: 'Sturdy'},
  },
  Slurpum: {
    types: ['Fairy', 'Fighting'],
    bs: {hp: 81, at: 115, df: 93, sa: 82, sd: 77, sp: 81},
    weightkg: 16,
    abilities: {0: 'Poison Heal'},
  },
  Grousle: {
    types: ['Ground', 'Electric'],
    bs: {hp: 90, at: 100, df: 90, sa: 110, sd: 94, sp: 92},
    weightkg: 16,
    abilities: {0: 'Flash Fire'},
  ...
  'Grousle-Primal': {
    types: ['Ground', 'Fire'],
    bs: {hp: 90, at: 130, df: 110, sa: 160, sd: 94, sp: 92},
    weightkg: 0,
    abilities: {0: 'Desolate Land'},
    baseSpecies: 'Grousle',
  },
  Corveot: {
    types: ['Steel', 'Flying'],
    bs: {hp: 95, at: 85, df: 110, sa: 70, sd: 80, sp: 85},
    weightkg: 75,
    abilities: {0: 'Pressure'},
  ...
  'Corveot-Mega': {
    types: ['Steel', 'Flying'],
    bs: {hp: 95, at: 85, df: 115, sa: 135, sd: 90, sp: 105},
    weightkg: 0,
    abilities: {0: 'No Guard'},
    baseSpecies: 'Corveot',
  },
  'Igglyzenta-Crowned': {
    types: ['Fairy', 'Steel'],
    bs: {hp: 93, at: 80, df: 100, sa: 60, sd: 100, sp: 71},
    weightkg: 18,
    abilities: {0: 'Dauntless Shield'},
  },
  'Arctres-Galar': {
    types: ['Fire', 'Dark'],
    bs: {hp: 90, at: 112, df: 95, sa: 102, sd: 105, sp: 102},
    weightkg: 100,
    abilities: {0: 'Honey Gather'},
  },
  Garborude: {
    types: ['Poison', 'Dark'],
    bs: {hp: 101, at: 123, df: 100, sa: 70, sd: 90, sp: 91},
    weightkg: 0.4,
    abilities: {0: 'Weak Armor'},
  },
  Noicity: {
    types: ['Electric', 'Flying'],
    bs: {hp: 86, at: 75, df: 86, sa: 109, sd: 75, sp: 118},
    weightkg: 120,
    abilities: {0: 'Punk Rock'},
  },
  Ferros: {
    types: ['Water', 'Steel'],
    bs: {hp: 80, at: 50, df: 70, sa: 40, sd: 92, sp: 22},
    weightkg: 19.5,
    abilities: {0: 'Sticky Hold'},
    nfe: true,
  },
  'Landmaldo-Therian': {
    types: ['Ground', 'Bug'],
    bs: {hp: 102, at: 145, df: 95, sa: 90, sd: 80, sp: 75},
    weightkg: 215,
    abilities: {0: 'Honey Gather'},
  },
  'Tentoxys-Defense': {
    types: ['Psychic', 'Poison'],
    bs: {hp: 65, at: 75, df: 122, sa: 90, sd: 140, sp: 105},
    weightkg: 190,
    abilities: {0: 'Grassy Surge'},
  },
  'Strikados-Galar': {
    types: ['Electric', 'Fighting'],
    bs: {hp: 86, at: 123, df: 84, sa: 82, sd: 86, sp: 115},
    weightkg: 50,
    abilities: {0: 'Defiant'},
  },
  Hooporant: {
    types: ['Water', 'Psychic'],
    bs: {hp: 75, at: 100, df: 70, sa: 120, sd: 115, sp: 95},
    weightkg: 11,
    abilities: {0: 'Magician'},
  },
  Brontun: {
    types: ['Dragon', 'Steel'],
    bs: {hp: 90, at: 90, df: 115, sa: 90, sd: 115, sp: 31},
    weightkg: 115.5,
    abilities: {0: 'Thick Fat'},
  },
  Mesflame: {
    types: ['Fire', 'Psychic'],
    bs: {hp: 95, at: 95, df: 95, sa: 95, sd: 95, sp: 104},
    weightkg: 2,
    abilities: {0: 'Levitate'},
  },
  'Thornbro-Galar': {
    types: ['Grass', 'Poison'],
    bs: {hp: 101, at: 99, df: 113, sa: 80, sd: 111, sp: 25},
    weightkg: 11.5,
    abilities: {0: 'Anticipation'},
    nfe: true,
  },
  Glidol: {
    types: ['Ground', 'Flying'],
    bs: {hp: 67, at: 94, df: 124, sa: 67, sd: 97, sp: 94},
    weightkg: 43,
    abilities: {0: 'Poison Heal'},
  },
  Pincurchitar: {
    types: ['Rock', 'Electric'],
    bs: {hp: 97, at: 117, df: 102, sa: 103, sd: 102, sp: 38},
    weightkg: 40,
    abilities: {0: 'Sand Stream'},
  ...
  'Pincurchitar-Mega': {
    types: ['Rock', 'Electric'],
    bs: {hp: 97, at: 147, df: 142, sa: 103, sd: 122, sp: 48},
    weightkg: 0,
    abilities: {0: 'Sand Stream'},
  ...
  Snortine: {
    types: ['Normal', 'Water'],
    bs: {hp: 130, at: 85, df: 70, sa: 85, sd: 130, sp: 51},
    weightkg: 89,
    abilities: {0: 'Immunity'},
  },
  Flygalge: {
    types: ['Poison', 'Dragon'],
    bs: {hp: 92, at: 87, df: 103, sa: 88, sd: 103, sp: 72},
    weightkg: 2.5,
    abilities: {0: 'Adaptability'},
  },
  Absable: {
    types: ['Dark', 'Ghost'],
    bs: {hp: 60, at: 110, df: 70, sa: 70, sd: 75, sp: 75},
    weightkg: 950,
    abilities: {0: 'Prankster'},
    otherFormes: ['Absable-Mega-X'],
  },
  'Absable-Mega-X': {
    types: ['Dark', 'Ghost'],
    bs: {hp: 60, at: 130, df: 70, sa: 110, sd: 75, sp: 115},
    weightkg: 0,
    abilities: {0: 'Magic Bounce'},
    baseSpecies: 'Absable',
  },
  'Absable-Mega-Y': {
    types: ['Dark', 'Ghost'],
    bs: {hp: 60, at: 120, df: 120, sa: 90, sd: 125, sp: 45},
    weightkg: 0,
    abilities: {0: 'Magic Bounce'},
    baseSpecies: 'Absable',
  },
  Scolisharp: {
    types: ['Dark', 'Bug'],
    bs: {hp: 70, at: 125, df: 95, sa: 60, sd: 80, sp: 95},
    weightkg: 62,
    abilities: {0: 'Defiant'},
  },
  Ninjacross: {
    types: ['Bug', 'Fighting'],
    bs: {hp: 72, at: 117, df: 60, sa: 45, sd: 80, sp: 142},
    weightkg: 1,
    abilities: {0: 'Honey Gather'},
  ...
  'Ninjacross-Mega': {
    types: ['Bug', 'Fighting'],
    bs: {hp: 72, at: 177, df: 100, sa: 45, sd: 90, sp: 132},
    weightkg: 1,
    abilities: {0: 'Skill Link'},
  ...
  Gossephalon: {
    types: ['Grass', 'Fire'],
    bs: {hp: 61, at: 89, df: 71, sa: 127, sd: 101, sp: 103},
    weightkg: 42,
    abilities: {0: 'Regenerator'},
  },
  Dracodoom: {
    types: ['Dragon', 'Dark'],
    bs: {hp: 95, at: 95, df: 80, sa: 110, sd: 75, sp: 87},
    weightkg: 61,
    abilities: {0: 'Flash Fire'},
  ...
  'Dracodoom-Mega': {
    types: ['Dragon', 'Dark'],
    bs: {hp: 95, at: 115, df: 120, sa: 140, sd: 85, sp: 107},
    weightkg: 61,
    abilities: {0: 'Solar Power'},
  ...
  Toucosta: {
    types: ['Water', 'Flying'],
    bs: {hp: 95, at: 115, df: 120, sa: 80, sd: 70, sp: 50},
    weightkg: 5,
    abilities: {0: 'Solid Rock'},
  },
  'Weezlord-Galar': {
    types: ['Fairy', 'Dark'],
    bs: {hp: 151, at: 103, df: 97, sa: 103, sd: 61, sp: 53},
    weightkg: 3.4,
    abilities: {0: 'Unaware'},
  },
  Sableior: {
    types: ['Rock', 'Ghost'],
    bs: {hp: 55, at: 107, df: 67, sa: 102, sd: 62, sp: 115},
    weightkg: 5.1,
    abilities: {0: 'Prankster'},
  ...
  'Sableior-Meteor': {
    types: ['Rock', 'Ghost'],
    bs: {hp: 55, at: 67, df: 107, sa: 62, sd: 102, sp: 55},
    weightkg: 5.1,
    abilities: {0: 'Prankster'},
  ...
  'Sableior-Mega': {
    types: ['Rock', 'Ghost'],
    bs: {hp: 55, at: 117, df: 117, sa: 122, sd: 112, sp: 85},
    weightkg: 5.1,
    abilities: {0: 'Magic Bounce'},
    baseSpecies: 'Sableior',
  },
  'Sableior-Mega': {
    types: ['Rock', 'Ghost'],
    bs: {hp: 55, at: 77, df: 157, sa: 82, sd: 152, sp: 25},
    weightkg: 5.1,
    abilities: {0: 'Magic Bounce'},
    baseSpecies: 'Sableior',
  },
  Eeluk: {
    types: ['Electric', 'Poison'],
    bs: {hp: 105, at: 120, df: 87, sa: 95, sd: 100, sp: 60},
    weightkg: 4.8,
    abilities: {0: 'Levitate'},
  },
  'Maroligatr-Alola': {
    types: ['Ghost', 'Water'],
    bs: {hp: 82, at: 102, df: 115, sa: 74, sd: 91, sp: 71},
    weightkg: 5.5,
    abilities: {0: 'Sheer Force'},
  },
  Frozerade: {
    types: ['Ice', 'Poison'],
    bs: {hp: 75, at: 85, df: 77, sa: 102, sd: 97, sp: 110},
    weightkg: 28,
    abilities: {0: 'Technician'},
  },
  Hattataka: {
    types: ['Psychic', 'Steel'],
    bs: {hp: 60, at: 128, df: 155, sa: 110, sd: 105, sp: 21},
    weightkg: 45.2,
    abilities: {0: 'Magic Bounce'},
  },
  Glasnow: {
    types: ['Ice'],
    bs: {hp: 100, at: 130, df: 120, sa: 80, sd: 100, sp: 45},
    weightkg: 0,
    abilities: {0: 'Soundproof'},
  ...
  'Glasnow-Mega': {
    types: ['Ice'],
    bs: {hp: 100, at: 170, df: 150, sa: 120, sd: 120, sp: 15},
    weightkg: 0,
    abilities: {0: 'Snow Warning'},
    baseSpecies: 'Glasnow',
  },
  Kokovoir: {
    types: ['Fairy'],
    bs: {hp: 69, at: 110, df: 75, sa: 110, sd: 100, sp: 120},
    weightkg: 0,
    abilities: {0: 'Electric Surge'},
  ...
  'Kokovoir-Mega': {
    types: ['Fairy'],
    bs: {hp: 69, at: 130, df: 75, sa: 150, sd: 120, sp: 140},
    weightkg: 0,
    abilities: {0: 'Pixilate'},
  ...
  Kyottler: {
    types: ['Water', 'Bug'],
    bs: {hp: 80, at: 87, df: 90, sa: 105, sd: 120, sp: 60},
    weightkg: 0,
    abilities: {0: 'Drizzle'},
  ...
  'Kyottler-Primal': {
    types: ['Fairy'],
    bs: {hp: 80, at: 137, df: 90, sa: 135, sd: 140, sp: 60},
    weightkg: 0,
    abilities: {0: 'Primordial Sea'},
  ...
  'Clawriwrath': {
    types: ['Water', 'Fighting'],
    bs: {hp: 80, at: 84, df: 91, sa: 113, sd: 91, sp: 84},
    weightkg: 32.5,
    abilities: {0: 'Mega Launcher'},
  },
  'Meloslash-Ranged': {
    types: ['Normal', 'Ghost'],
    bs: {hp: 100, at: 63, df: 108, sa: 109, sd: 134, sp: 75},
    weightkg: 0,
    abilities: {0: 'Stance Change'},
  ...
  'Meloslash-Melee': {
    types: ['Normal', 'Ghost'],
    bs: {hp: 100, at: 109, df: 75, sa: 63, sd: 108, sp: 134},
    weightkg: 0,
    abilities: {0: 'Stance Change'},
    baseSpecies: 'Meloslash-Ranged',
  },
  Tornachamp: {
    types: ['Flying', 'Fighting'],
    bs: {hp: 94, at: 125, df: 87, sa: 100, sd: 90, sp: 85},
    weightkg: 7.5,
    abilities: {0: 'No Guard'},
  },
  Cofazor: {
    types: ['Ghost', 'Steel'],
    bs: {hp: 65, at: 90, df: 125, sa: 88, sd: 95, sp: 67},
    weightkg: 3,
    abilities: {0: 'Technicican'},
    otherFormes: ['Cofazor-Mega'],
  },
  'Cofazor-Mega': {
    types: ['Electric', 'Dark'],
    bs: {hp: 65, at: 110, df: 165, sa: 98, sd: 115, sp: 77},
    weightkg: 3,
    abilities: {0: 'Technicican'},
    baseSpecies: 'Cofazor',
  },
  Talonsyl: {
    types: ['Fairy', 'Flying'],
    bs: {hp: 86, at: 93, df: 70, sa: 93, sd: 99, sp: 110},
    weightkg: 8.9,
    abilities: {0: 'Aerilate'},
  },
  Heatki: {
    types: ['Fire', 'Steel'],
    bs: {hp: 90, at: 85, df: 101, sa: 120, sd: 101, sp: 77},
    weightkg: 46,
    abilities: {0: 'Flash Fire'},
  },
  Sirsola: {
    types: ['Fighting', 'Ghost'],
    bs: {hp: 81, at: 125, df: 75, sa: 106, sd: 110, sp: 50},
    weightkg: 46,
    abilities: {0: 'Scrappy'},
  },
  'Noze-Dawn-Wings': {
    types: ['Psychic', 'Rock'],
    bs: {hp: 73, at: 79, df: 127, sa: 113, sd: 113, sp: 61},
    weightkg: 40.8,
    abilities: {0: 'Magnet Pull'},
    otherFormes: ['Noze-Ultra'],
  },
  'Noze-Ultra': {
    types: ['Psychic', 'Dragon'],
    bs: {hp: 73, at: 123, df: 97, sa: 123, sd: 97, sp: 113},
    weightkg: 0,
    abilities: {0: 'Neuroforce'},
  ...
  Bruxray: {
    types: ['Electric', 'Psychic'],
    bs: {hp: 82, at: 120, df: 82, sa: 85, sd: 82, sp: 86},
    weightkg: 28,
    abilities: {0: 'Strong Jaw'},
  },
  Kingdeedee: {
    types: ['Psychic'],
    bs: {hp: 90, at: 70, df: 70, sa: 110, sd: 115, sp: 65},
    weightkg: 1,
    abilities: {0: 'Honey Gather'},
  },
  'Tapu Koma': {
    types: ['Normal', 'Fairy'],
    bs: {hp: 87, at: 122, df: 100, sa: 80, sd: 105, sp: 70},
    weightkg: 9,
    abilities: {0: 'Grassy Surge'},
  },
  Hawlazzle: {
    types: ['Poison', 'Fighting'],
    bs: {hp: 73, at: 78, df: 67, sa: 113, sd: 67, sp: 131},
    weightkg: 80,
    abilities: {0: 'Mold Breaker'},
  },
  Whimsilotic: {
    types: ['Water', 'Fairy'],
    bs: {hp: 85, at: 63, df: 85, sa: 105, sd: 105, sp: 105},
    weightkg: 200,
    abilities: {0: 'Infiltrator'},
  },
  Vullacham: {
    types: ['Fighting', 'Flying'],
    bs: {hp: 65, at: 57, df: 75, sa: 72, sd: 90, sp: 70},
    weightkg: 90,
    abilities: {0: 'Fur Coat'},
    otherFormes: ['Vullacham-Mega'],
  },
  'Vullacham-Mega': {
    types: ['Fighting', 'Flying'],
    bs: {hp: 65, at: 97, df: 85, sa: 92, sd: 100, sp: 90},
    weightkg: 90,
    abilities: {0: 'Fur Coat'},
  ...
  Dracolix: {
    types: ['Dragon','Ground'],
    bs: {hp: 85, at: 90, df: 170, sa: 65, sd: 75, sp: 60},
    weightkg: 65.5,
    abilities: {0: 'Water Absorb'},
    otherFormes: ['Dracolix-Mega'],
  },
  'Dracolix-Mega': {
    types: ['Dragon','Ground'],
    bs: {hp: 85, at: 130, df: 200, sa: 65, sd: 105, sp: 60},
    weightkg: 65.5,
    abilities: {0: 'Sand Force'},
  ...
  Serpanadel: {
    types: ['Grass','Dragon'],
    bs: {hp: 79, at: 89, df: 89, sa: 101, sd: 89, sp: 127},
    weightkg: 4.5,
    abilities: {0: 'Honey Gather'},
    nfe: true,
  },
  Accelest: {
    types: ['Bug', 'Steel'],
    bs: {hp: 89, at: 89, df: 83, sa: 107, sd: 89, sp: 113},
    weightkg: 7.6,
    abilities: {0: 'Honey Gather'},
    nfe: true,
  },
  'Buzzeggutor-Alola': {
    types: ['Dragon', 'Fighting'],
    bs: {hp: 101, at: 127, df: 127, sa: 89, sd: 79, sp: 67},
    weightkg: 0.2,
    abilities: {0: 'Frisk'},
  },
};
